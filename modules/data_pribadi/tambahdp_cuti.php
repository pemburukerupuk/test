...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item">
        <a href="index.php?page=dp_cuti">Master Cuti</a>
      </li>
      <li class="breadcrumb-item active">Tambah Cuti</li>
      <hr>
      <li>
        <a href="index.php?page=dp_cuti"><button>Kembali</button></a>
      </li>
    </ol>
    ...
    <div class="card mb-3 col-md-6">
      ...
      <div class="card-body">
        <form action="index.php?page=process_tambahdp_cuti&p_id=<?php echo $_GET['p_id']; ?>" method="POST" enctype="multipart/form-data">
