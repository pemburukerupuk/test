...
<div class="container-fluid">
  ...
  <div class="row">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                  <div class="form-row">
                    <div class="col-md-6">
                        <label for="ubahnip">Ubah NIP</label>
                    </div>
                    <div class="col-md-6">
                        <input name="ubahnip" type="checkbox" id="check" value="true">
                        <label for="check">Saya Setuju</label>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="form-row">
                    <div class="col-md-12">
                        <label for="nipbaru">Nomor Induk Pegawai Baru</label>
                        <input class="form-control" id="nipbaru" name="nipbaru" type="text">
                    </div>
    ...
    <div class="col-lg-4">
          ...
          <!-- Example Bar Chart Card-->
          <div class="card mb-3">
            <form action="index.php?page=process_p_editlevel&p_id=<?php echo $p_id; ?>" method="POST">
            <div class="card-header"><b>Level</b></div>
              <div class="card-body">
                <div class="form-group">
                  <div class="form-row">
                  <div><label for="status">Level</label></div>
                    <div class="col-md-12">
                          <select class="form-control" name="l_id">
                            <?php
                                $sql = $con->query("SELECT * FROM level");

                                while($level = $sql->fetch_array()){
                            ?>
                                <option name="l_id" value="<?php echo $level['l_id'] ?>" <?php if($level['l_id'] == $row['l_id']) echo 'selected'; ?> > <?php echo $level['level'] ?></option>
                              <?php
                                }
                              ?>
                          </select> 
            ...
            <div class="card-footer small text-muted">
              <button class="btn btn-primary btn-block" type="submit" onclick="return confirm('Apakah Anda Setuju ?'); ">Update Level</button>
              <button class="btn btn-primary btn-block" type="reset">Reset</button>
            </div> 
            </form>    
          </div>
